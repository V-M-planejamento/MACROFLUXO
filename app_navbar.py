...
GRUPOS = {
    ...
    "LIMPEZA 'SUPRESSÃO'": ["PL.LIMP","LEG.LIMP","ENG.LIMP.","EXECUÇÃO LIMP.",],"TERRAPLANAGEM": ["PL.TER.","LEG.TER.","ENG. TER.","EXECUÇÃO TER.",],
    "INFRA INCIDENTE (SAA E SES)": ["PL.INFRA","LEG.INFRA","ENG. INFRA","EXECUÇÃO INFRA","ENG. PAV","EXECUÇÃO PAV."],
    "PULMÃO": ["PULMÃO INFRA"],
...
selected_page = option_menu(
    menu_title=None,
    options=["Home", "Equipes", "Resumo"],
    icons=['house', 'book', 'code-slash', 'play-circle', 'people', 'github'],
    menu_icon="cast",
    default_index=0,
    orientation="horizontal",
    styles={
        "container": {"padding": "0!important", "background-color": "#a3b0cd"}, # Cor de fundo da barra
        "icon": {"color": "white", "font-size": "16px"},
        "nav-link": {
            "font-size": "14px",
            "text-align": "center",
            "margin": "0px 10px",
            "--hover-color": "rgba(255, 255, 255, 0.2)", # Cor ao passar o mouse
            "color": "white" # Cor do texto
        },
        "nav-link-selected": {"background-color": "rgba(0, 0, 0, 0.2)"}, # Fundo do item selecionado
    }
)
...
<style>
    ...
    div.stMultiSelect div[role="option"] input[type="checkbox"]:checked + div > div:first-child {
        background-color: #9b9fa7 !important;
        border-color: #9b9fa7 !important;
    }
...
elif selected_page == "Resumo":
    pass

elif selected_page == "Equipes":
    pass
